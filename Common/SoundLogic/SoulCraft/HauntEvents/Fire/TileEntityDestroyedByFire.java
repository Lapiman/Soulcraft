...
public class TileEntityDestroyedByFire extends TileEntitySpecialFire{
	public int storedBlockID;
	public int storedBlockMetadata;
    ...
    public boolean removeIfMatches(int id)
    {
    	...
    	this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, storedBlockID,storedBlockMetadata,2);
    	return true;
    }
