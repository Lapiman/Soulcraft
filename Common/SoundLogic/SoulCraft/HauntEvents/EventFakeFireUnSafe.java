...
public class EventFakeFireUnSafe extends HauntEvent {

	int x,y,z,duration,id;
	World world;
	public EventFakeFireUnSafe()
	{
	}
	public EventFakeFireUnSafe(World world, int x,int y,int z)
	{
		this.x=x;
		this.y=y;
		this.z=z;
	...
	public void StartEvent() {
		world.setBlock(x, y, z, SoulMod.proxy.fakeFireDmg.blockID);
